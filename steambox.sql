...
CREATE TABLE `article`  (
  ...
  `hidden` tinyint(0) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `category` VALUES (10, '卡牌', 0);
...
-- ----------------------------
INSERT INTO `community` VALUES (1, '荒野大镖客2：救赎', 'https://store.steampowered.com/app/1174180/Red_Dead_Redemption_2/', 1);
...
INSERT INTO `community` VALUES (4, '双人成行', 'https://store.steampowered.com/app/1426210/', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'test', 'e1adc3949ba59abbe56e057f2f883e', 'Steve', '1.jpg', '2021-12-09', 'abc@qq.com', '15145678910', '2021-12-20 17:26:46', 1);
INSERT INTO `user` VALUES (2, 'test1', 'e1adc3949ba59abbe56e057f2f883e', '绝地大叔', '4.jpg', '2021-12-14', 'abc123@qq.com', '15145678911', '2021-12-20 18:39:58', 1);
INSERT INTO `user` VALUES (3, 'test233', 'e1adc3949ba59abbe56e057f2f883e', '三月寒', '2.jpg', '2022-01-18', 'abc456@qq.com', '15145678912', '2022-01-18 12:14:03', 1);
