...
<script type="text/javascript">
    ...
    function Through(ArticleId) {
        if (confirm("您确定要通过吗?")) {
            window.location.replace("${pageContext.request.contextPath}/Article/setArticleThrough?articleId=" + ArticleId);
        }
    }

    function setBack(ArticleId) {
        if (confirm("您确定要退回吗?")) {
            window.location.replace("${pageContext.request.contextPath}/Article/setArticleBack?articleId=" + ArticleId);
        }
    }
